...
-- Ícone redondo do Nadal (para quando minimizado)
...
MinimizedIcon.Image = "rbxassetid://11646292533" -- ícone Nadal oficial no Roblox
...
-- Criar toggles e sliders na interface
local toggles = {}
local yPos = 40
...
-- Função para achar o jogador mais próximo no FOV
