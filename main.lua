...
-- Ícone minimizado estilo Nadal, fundo branco e borda azul
...
MinimizedIcon.BorderColor3 = Color3.fromRGB(0, 170, 255) -- borda azul escaldante
...
MinimizedIcon.TextStrokeColor3 = Color3.new(0, 0, 0)
MinimizedIcon.TextStrokeTransparency = 0.7
MinimizedIcon.AutomaticSize = Enum.AutomaticSize.None
