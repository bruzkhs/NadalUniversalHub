...
-- Criar toggles e sliders e posicionar
local toggles = {}
local yPos = 40
...
local function addToggle(name, default)
    ...
    btn.MouseButton1Click:Connect(function()
        ...
        print(name .. " toggled to " .. tostring(state[name]))
    end)
end
...
-- Função pra achar o player mais próximo dentro do FOV
